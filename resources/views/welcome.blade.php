        ...
        <head>
            ...
            <title> سرکار </title>
            @vite('resources/css/app.css')<!-- Small CSS to Hide elements at 1520px size -->
            <style>
        ...
        <body class="overflow-x-hidden antialiased">
            ...
            <header class="relative z-50 w-full h-24">
                <div
                    ...
                    <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                        ...
                        <span class="ml-3 text-xl text-gray-800">سرکار<span class="text-pink-500">.</span></span>
                    </a>
        
                    <nav id="nav"
                        class="absolute top-0 left-0 z-50 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative">
                        <a href="#"
                            class="ml-0 mr-0 font-bold duration-100 md:ml-12 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600"> خانه </a>
                        <a href="#features"
                            class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">ویژگی ها</a>
                        <a href="#pricing"
                            class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600"> قیمت ها </a>
                        <a href="#testimonials"
                ...
                <div
                    ...
                    <div
                        ...
                        <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">
                             با اپلیکیشن سرکار حساب و کتاب شما سریع و بدون دردسر انجام می شود</h1>
                        ...
                        <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
                            <p class="mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase">همکاران ما</p>
                            <div class="flex">
            ...
            <div id="features" class="relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
                <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
                    <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">ویژگی های ما</h2>
                    <h3
                        class="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-6xl">
                        :وقتی از سرکار استفاده می کنید</h3>
                    <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
                        ...
                        <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                            <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                                ...
                                <h4 class="relative mt-6 text-lg font-bold">پشتیبانی 24 ساعته</h4>
                                <p class="relative mt-2 text-base text-center text-gray-600">
                                    ما به صورت 24 ساعته منتظریم تا شما با ما در ارتباط شوید که باهم بتوانیم به مسایل فایق آییم.
                                </p>
                                <a href="#_" class="relative flex mt-2 text-sm font-medium text-indigo-500 underline"> بیشتر بخوانید </a>
                            </div>
                        </div>
                        ...
                        <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                            <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                                ...
                                <h4 class="relative mt-6 text-lg font-bold">مشتری مداری</h4>
                                <p class="relative mt-2 text-base text-center text-gray-600">
                                    ما به مشتریان مان حقوقی قایل هستیم که دیگر اپلیکیشن ها به آنها پابند نیستند!
                                </p>
                                <a href="#_" class="relative flex mt-2 text-sm font-medium text-indigo-500 underline">بیشتر بخوانید</a>
                            </div>
                        </div>
